const { ContainerBuilder, ButtonBuilder, ButtonStyle, SlashCommandBuilder, StringSelectMenuBuilder, StringSelectMenuOptionBuilder, MessageFlags } = require("discord.js");
...
function buildEggsView(nests, selectedNestId = null) {
    const container = new ContainerBuilder()
        .setAccentColor(COLORS.PRIMARY)
        .addActionRowComponents((actionRow) =>
            actionRow.setComponents(buildCategorySelectMenu('eggs')),
        );

    if (nests) {
        container.addActionRowComponents((actionRow) =>
            actionRow.setComponents(buildNestSelectMenu(nests, selectedNestId)),
        );
    }
